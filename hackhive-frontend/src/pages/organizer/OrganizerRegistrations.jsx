...
import { UserCheck, AlertCircle, RotateCcw, Building2, Calendar, FolderGit2, Trophy } from "lucide-react";
...
import OrganizerProjectResults from "../../components/organizer/projectResult/OrganizerProjectResults";

export default function OrganizerRegistrations({ defaultTab = "registrations" }) {
    ...
    return (
        <div className="space-y-6 pb-20 w-full max-w-7xl mx-auto text-slate-900 dark:text-slate-100">
                ...
                <button
                    ...
                    className={`inline-flex items-center gap-2 px-4 py-2 text-xs font-bold rounded-xl transition ${
                        activeTab === "registrations"
                            ? "bg-slate-900 text-white shadow-2xs dark:bg-purple-600"
            ...
            {activeTab === "results" ? (
                <OrganizerProjectResults selectedEventId={selectedEventId} />
            ) : activeTab === "submissions" ? (
