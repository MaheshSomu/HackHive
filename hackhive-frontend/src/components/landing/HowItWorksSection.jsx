...
export default function HowItWorksSection() {
    const steps = [
        ...
        },
        {
            ...
            icon: UserCheck,
            title: "Register",
            description: "Join an event and reserve your place.",
        },
        {
            number: "03",
            icon: Users,
    ...
    return (
        <section id="how-it-works" className="py-16 lg:py-20 bg-slate-50/60 dark:bg-slate-900/40 border-y border-slate-200/80 dark:border-slate-800/80">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
                ...
                <div className="text-center max-w-2xl mx-auto space-y-2">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">
                        Everything you need to go from discovering a hackathon to submitting your project.
                    </p>
                </div>

                {/* Horizontal Connected Workflow Sequence */}
