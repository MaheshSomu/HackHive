...
export default function TwoExperiencesSection() {
    const studentList = [
        "Discover hackathons",
        "Register for events",
    ...
    return (
        <section id="experiences" className="py-16 lg:py-20 bg-white dark:bg-slate-950">
